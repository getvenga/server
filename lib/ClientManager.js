...
class ClientManager {
    constructor(opt) {
        ...
        this.startPort = 45000;
        this.handedOutPorts = 0;
    }
    ...
    async newClient(id) {
        ...
        this.handedOutPorts = this.handedOutPorts + 1;
        ...
        const agent = new TunnelAgent({
            ...
            port: this.startPort + this.handedOutPorts,
        });
        ...
        client.once('close', () => {
            this.debug('close event for client %s', id);
        ...
        try {
            ...
            this.debug('error in client: %s', err);
            this.removeClient(id);
